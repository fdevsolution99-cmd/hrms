    ...
    <div className="max-w-4xl mx-auto mt-4 md:mt-10 bg-white p-4 md:p-8 rounded-md shadow-md">
      ...
      <form onSubmit={handleSubmit} autoComplete="off">
        ...
        <button
          type="submit"
          disabled={loading}
          className={`w-full mt-6 bg-teal-600 hover:bg-teal-700 text-white font-bold py-2 px-4 rounded transition-all duration-200 ${loading ? 'opacity-70 cursor-not-allowed' : ''}`}
        >
          {loading ? (
