    ...
    const htmlContent = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
        <div style="text-align: center; margin-bottom: 30px;">
          <h2 style="color: #2563eb; margin: 0;">FDEV SOLUTIONS PRIVATE LIMITED</h2>
          <p style="color: #666; margin: 5px 0;">501, 5th floor, Veekay Prime, Patrika Nagar, Hi-Tech City Hyderabad Telangana 500081</p>
        ...
        <div style="text-align: center; color: #6b7280; font-size: 12px; border-top: 1px solid #e5e7eb; padding-top: 15px;">
          ...
          <p>© ${new Date().getFullYear()} FDEV SOLUTIONS PRIVATE LIMITED. All rights reserved.</p>
        </div>
      </div>
    `;
