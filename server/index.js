...
const allowedOrigins = [process.env.CLIENT_URL, "http://localhost:5000", "http://localhost:5173", "http://localhost:5174","https://FDEVhrms.com","https://www.FDEVhrms.com"].filter(Boolean);
