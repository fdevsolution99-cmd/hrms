...
export const getAnnouncementEmailTemplate = ({ title, description, imageUrl, recipientName, createdAt }) => {
  ...
  return `
    ...
    <p>We have an important announcement to share with you from FDEV SOLUTIONS PVT LTD.</p>
...
export const getAnnouncementEmailSubject = (title) => {
  return `📢 Important Announcement: ${title} - FDEV SOLUTIONS`;
};